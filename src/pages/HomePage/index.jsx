  ...
  return (
    <Layout>
      ...
      <div className='content mx-4 flex flex-col justify-center'>
        <Link
          className='btn event-btn mx-auto relative -top-16 py-3 px-5 text-xl animate-bounce duration-700'
          to='/events'
        >
          See Events Here
        </Link>
        <div className='body relative -top-3'>
          ...
          <p className='mx-14 mt-6 text-2xl'>
            Due to the Covid-19 pandemic, we will be hosting our annual
