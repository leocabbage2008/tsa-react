    ...
    <Layout title='About Us'>
      ...
      <div className='content px-4'>
        ...
        <p className='text-center text-xl mt-1'>
          We are Pennsylvania TSA's Website Design Team 1023-901, with members
          1023-013, 1023-011 and 1023-033. We chose the Lantern Festival as our
          theme because it aims to promote reconciliation, peace, and
